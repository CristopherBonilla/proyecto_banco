...
@Component({
  selector: 'app-suspencion-clientes-admin',
  templateUrl: './suspencion-clientes-admin.component.html',
  styleUrls: ['./suspencion-clientes-admin.component.css'],
  providers: [{
    provide: MAT_RADIO_DEFAULT_OPTIONS,
    useValue: { color: 'primary' },
  }]
})
export class SuspencionClientesAdminComponent implements OnInit {
