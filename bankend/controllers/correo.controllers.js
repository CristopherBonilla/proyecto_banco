...
var controller = {
    validarCorreo: function (req, res) {
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Registro Cliente <sfqaeab@gmail.com>",
            to: correo,
    ...
    actualizarCliente: function (req, res) {
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Cambio de correo <sfqaeab@gmail.com>",
            to: correo,
            subject: "Validar correo electrónico",
            text: mensaje1 + '\n' + otp + '\n' + mensaje2
        }
    ...
    verificarCorreoLogin: function (req, res) {
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Ingreso a Banca Web <sfqaeab@gmail.com>",
            to: correo,
    ...
    bienvenidoBanquito: function (req, res) {
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Registro Exitoso <sfqaeab@gmail.com>",
            to: correo,
    ...
    nuevasCredencialesTemp: function (req, res) {
        ...
        var mensaje1 = "Estimado cliente," + '\n\n' + "PoliTech le informa: a las " + getTime() + " se han solicitado el reseteo de sus credenciales para acceder a la Banca Web. \n\n Si no realizó esta acción, por favor póngase en contacto con nuestro equipo de soporte al cliente.\n\nPara que puedas acceder a tu cuenta en la nuestra Banca Web utiliza estas credenciales:";
        var credenciales = "\n\n\t Username: " + username + "\n\n\t Password: " + pass + "\n\n\t Pregunta: " + pregunta;
        var mensaje2 = '\n\n' + "Tenga en cuenta que estas credenciales son temporales y debe actualizarlas ingresando por primera ves a la Banca Web.\n\nNuestro equipo de expertos en servicios financieros estará disponible para ayudarte en todo momento. Si tienes alguna pregunta o necesitas ayuda, no dudes en ponerte en contacto con nosotros. Nos complace ayudarte en todo lo que necesites.\n\n¡Gracias por confiar en nosotros!";
        function getTime() {
            var date = new Date();
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Nuevas Credenciales <sfqaeab@gmail.com>",
            to: correo,
    ...
    actualizarUsuario: function (req, res) {
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Actualización Exitoso <sfqaeab@gmail.com>",
            to: correo,
    ...
    reenviar: function (req, res) {
        ...
        var pregunta = params.pregunta;
        var credenciales = "\n\n\t Username: " + username + "\n\n\t Password: " + pass + "\n\n\t Pregunta: " + pregunta;
        var mensaje1 = "Estimado cliente," + '\n\n' + "PoliTech le informa: a las " + getTime() + " se ha solicitado el reenvio de sus creedenciales para acceder a la Banca Web.\n\nPara que puedas acceder a tu cuenta en la nuestra Banca Web utiliza estas credenciales:";
        var mensaje2 = '\n\n' + "Tenga en cuenta que estas credenciales son temporales y debe actualizarlas ingresando por primera ves a la Banca Web.\n\nNuestro equipo de expertos en servicios financieros estará disponible para ayudarte en todo momento. Si tienes alguna pregunta o necesitas ayuda, no dudes en ponerte en contacto con nosotros. Nos complace ayudarte en todo lo que necesites.\n\n¡Gracias por confiar en nosotros!";
        //Funcion para mostrar la fecha y hora actual para el correo
        function getTime() {
            var date = new Date();
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Condifencial <sfqaeab@gmail.com>",
            to: correo,
    ...
    actualizar: function (req, res) {
        ...
        var params = req.body;
        var correo = params.correo;
        var mensaje1 = "Estimado cliente," + '\n\n' + "PoliTech le informa: a las " + getTime() + " se han actualizado sus datos. \n\n Si no realizó esta acción, por favor póngase en contacto con nuestro equipo de soporte al cliente";
        //Funcion para mostrar la fecha y hora actual para el correo
        function getTime() {
            var date = new Date();
            var hr = date.getHours();
    ...
    confirmarTransferencia: function (req, res) {
        ...
        var params = req.body;
        var correo = params.correo;
        var mensaje1 = "Estimado Cliente" + '\n\n' + "PoliTech le informa que a las: " + getTime() + "se ha solicitado una petición para efectuar una trnasferencia. Su código para la Banca Virtual es: \n\n "
        var mensaje2 = "\n\n Si no realizó esta acción, por favor póngase en contacto con nuestro equipo de soporte al cliente";
        var otp = "";
        console.log(params);
        //fecha y hora
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Confirmar Transferencias <sfqaeab@gmail.com>",
            to: correo,
    ...
    transferenciaExitosa: function (req, res) {
        ...
        mensaje = "Estimado Cliente" + '\n\n' + "PoliTech le informa que a las: " + getTime() + "se ha realizado un movimiento en su banca web." +
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Resumen <sfqaeab@gmail.com>",
            to: correo,
    ...
    loginExitoso: function (req, res) {
        ...
        var params = req.body;
        var correo = params.correo;
        var mensaje1 = "Estimado cliente," + '\n\n' + "PoliTech le informa: a las " + getTime() + " se han ingresado a su banca web. \n\n Si no realizó esta acción, por favor póngase en contacto con nuestro equipo de soporte al cliente";
        //Funcion para mostrar la fecha y hora actual para el correo
        function getTime() {
            var date = new Date();
            var hr = date.getHours();
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Ingreso Exitoso <sfqaeab@gmail.com>",
            to: correo,
    ...
    loginFallido: function (req, res) {
        ...
        var params = req.body;
        var correo = params.correo;
        var mensaje1 = "Estimado cliente,"+'\n\n'+"PoliTech le informa: a las "+getTime()+" se han intentado ingresar a su Banca Web. \n\n Si no realizó esta acción, por favor póngase en contacto con nuestro equipo de soporte al cliente";
        //Funcion para mostrar la fecha y hora actual para el correo
        function getTime(){
            var date = new Date();
            var hr = date.getHours(); 
        ...
        //Redactar correo
        var mailOptions = {
            from: "PoliTech - Ingreso Fallido <sfqaeab@gmail.com>",
            to: correo,
